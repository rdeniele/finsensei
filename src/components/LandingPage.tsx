...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      {/* Navigation */}
      <nav className="relative z-50 bg-gray-900/95 backdrop-blur-md border-b border-gray-700 top-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#blog" className="text-white hover:text-blue-400 transition-colors font-medium">
                Blog
              </a>
              <a href="#testimonials" className="text-white hover:text-blue-400 transition-colors font-medium">
                Testimonials
              </a>
              <Link
                href="/auth/signin"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-gray-800 border-t border-gray-700 shadow-lg">
            <div className="px-4 pt-4 pb-6 space-y-3">
              <a href="#features" className="block px-4 py-3 text-white hover:text-blue-400 hover:bg-gray-700 rounded-lg transition-colors font-medium">
                Features
              </a>
              <a href="#blog" className="block px-4 py-3 text-white hover:text-blue-400 hover:bg-gray-700 rounded-lg transition-colors font-medium">
                Blog
              </a>
              <a href="#testimonials" className="block px-4 py-3 text-white hover:text-blue-400 hover:bg-gray-700 rounded-lg transition-colors font-medium">
                Testimonials
              </a>
              <Link
                href="/auth/signin"
                className="block px-4 py-3 text-white hover:text-blue-400 hover:bg-gray-700 rounded-lg transition-colors font-medium"
              >
                Sign In
              </Link>
              <Link
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <Link
                href="/auth/signin"
                className="border-2 border-white text-white hover:border-blue-400 hover:text-blue-400 hover:bg-gray-800 px-10 py-5 rounded-2xl text-xl font-semibold transition-all duration-300"
              >
                Sign In
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="group bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-2xl hover:shadow-2xl transition-all duration-300 border border-gray-700 hover:border-blue-500 transform hover:-translate-y-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {statistics.map((stat, index) => {
              ...
              return (
                <div key={index} className="bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-700 text-center transform hover:scale-105 transition-all duration-300">
          ...
          <div className="mt-20 bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-blue-300 font-medium">Month 1</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-blue-300 font-medium">Month 2</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-blue-300 font-medium">Month 3</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-blue-300 font-medium">Month 6</span>
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-green-900/50 rounded-full flex items-center justify-center mr-4">
                      <CheckCircleIcon className="h-5 w-5 text-green-400" />
                    </div>
                    <span className="text-white font-medium">47% average savings increase</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-green-900/50 rounded-full flex items-center justify-center mr-4">
                      <CheckCircleIcon className="h-5 w-5 text-green-400" />
                    </div>
                    <span className="text-white font-medium">89% better budget control</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-green-900/50 rounded-full flex items-center justify-center mr-4">
                      <CheckCircleIcon className="h-5 w-5 text-green-400" />
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <button
              onClick={prevChart}
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-blue-400 p-3 rounded-full shadow-lg border border-gray-700 transition-colors"
            ...
            <button
              onClick={nextChart}
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-blue-400 p-3 rounded-full shadow-lg border border-gray-700 transition-colors"
      ...
      <section id="testimonials" className="py-24 bg-gradient-to-br from-gray-800 to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="group bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-700 hover:border-blue-500 transform hover:-translate-y-2">
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
      ...
      <section id="blog" className="py-24 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-4 py-2 bg-blue-900/50 text-white rounded-full text-sm font-semibold mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog, index) => (
              <article key={blog.id} className="group bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-700 hover:border-blue-500 overflow-hidden transform hover:-translate-y-2">
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-blue-900/70 text-blue-200">
                      {blog.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center bg-blue-900/70 px-3 py-2 rounded-lg">
                    ...
                    <div className="flex items-center bg-blue-900/70 px-3 py-2 rounded-lg">
                      ...
                      <span className="text-white font-semibold">{blog.readTime}</span>
                    </div>
                  </div>                  <h3 className="text-xl font-bold text-white mb-3 group-hover:text-blue-400 transition-colors line-clamp-2">
                    {blog.title}
                  </h3>
                  
                  <p className="text-white/90 mb-6 leading-relaxed line-clamp-3 text-lg">
                    {blog.excerpt}
                  </p>
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <Link
                      href={`/blog/${blog.slug}`}
                      className="inline-flex items-center text-blue-400 hover:text-blue-300 font-semibold transition-colors group-hover:underline"
                    >
                      Read More

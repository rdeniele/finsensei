      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl h-[600px] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex space-x-2">
          <input
            ...
            className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
            disabled={loading}
          />
          <button
            type="submit"
